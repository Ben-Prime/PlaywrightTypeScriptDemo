...
test('Mock API request body in Playwright', async ({ page }) => {

    // Intercepts all the calls to */**/api/v1/fruits and will return a custom response
    // i.e mock the api call before navigating
